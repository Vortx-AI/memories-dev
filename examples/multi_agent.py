"""
Multi-agent system coordinator example for the memories system.
"""
...
def main():
    """
    Main function to run the multi-agent system directly.
    Example usage: python3 multi_agent.py
    """
    # Load environment variables
    load_dotenv()
