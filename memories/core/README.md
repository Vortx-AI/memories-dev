...
### Advanced Flow Control (New in 2.0.5)
...
# New in 2.0.5: Tensor optimization
hot_memory.optimize_layout("model_weights")

# New in 2.0.5: Create snapshot
...
# New in 2.0.5: Partial retrieval
