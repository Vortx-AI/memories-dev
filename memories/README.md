...
[![Version](https://img.shields.io/badge/version-2.0.8-blue.svg)](https://github.com/Vortx-AI/memories-dev/releases/tag/v8)
...
> Collective AGI memory - v2.0.8 (March 14, 2025)

## 📋 Release Timeline
- **v1.0.0** - Released on February 14, 2025: Initial stable release with core functionality
- **v2.0.8** - May 01, 2025: Current development version with enhanced features
...
pip install memories-dev==2.0.8

# Or install with specific components
pip install "memories-dev[core,earth]==2.0.8"
```
