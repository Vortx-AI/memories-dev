...
[![Version](https://img.shields.io/badge/version-1.0.3-blue.svg)](https://github.com/Vortx-AI/memories-dev/releases/tag/v1.0.3)
...
pip install memories-dev==1.0.3

# With GPU support
pip install "memories-dev[gpu]"==1.0.3
```
...
- [GitHub Issues](https://github.com/Vortx-AI/memories-dev/issues)
