...
[![Research Paper](https://img.shields.io/badge/research-arxiv-red.svg)](https://arxiv.org/abs/)
...
docker pull vortx/memories-dev:2.0.2

# Run with GPU support
docker run --gpus all -p 8000:8000 -v ./data:/app/data vortx/memories-dev:2.0.2
```
