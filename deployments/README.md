...
### Standalone on GCP (New in 2.0.3)
...
software:
  container_image: memories/standalone:2.0.3
  environment:
...
If you're upgrading from v1.0.0 (February 14, 2025) to v2.0.3 (February 28, 2025), please note the following changes:
